...
public class SimpleShortenUrlService {
    ...
    public ShortenUrlCreateResponseDto generateShortenUrl(ShortenUrlCreateRequestDto shortenUrlCreateRequestDto) {
        ...
        log.debug("originalUrl = {}, shortenUrlKey = {}", originalUrl, shortenUrlKey);
    ...
    public String getOriginalUrlByShortenUrlKey(String shortenUrlKey) {
        ...
        if(null == shortenUrl)
            throw new NotFoundShortenUrlException("단축 URL을 찾지 못하였습니다. requestedURL = " + shortenUrlKey);
    ...
    private String getUniqueShortenUrlKey() {
        ...
        while(count++ < MAX_RETRY_COUNT) {
            ...
            // 재시도 하게되는곳 -> 재시도 시작 되면 즉시 warn 로그 남길 것
            log.warn("Shorten URL key collision detected. Retrying... (Attempt {}/{}): shortenUrlKey = {}", count, MAX_RETRY_COUNT, shortenUrlKey);
        }
